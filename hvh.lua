...
if hasDrawing then
    ...
    warn("Drawing library not available – ESP and FOV Circle disabled.")
...
local SilentAimSection = CombatTab:Section({ Title = "Silent Aim" })
SilentAimSection:Toggle({ Title = "Enabled", Callback = function(v) Settings.SilentAim.Enabled = v end })
SilentAimSection:Toggle({ Title = "Visibility Check", Value = true, Callback = function(v) Settings.SilentAim.VisibleCheck = v end })
SilentAimSection:Toggle({ Title = "Team Check", Value = false, Callback = function(v) Settings.SilentAim.TeamCheck = v end })
SilentAimSection:Slider({ Title = "FOV", Step = 10, Value = { Min = 10, Max = 500, Default = 200 }, Callback = function(v) Settings.SilentAim.FOV = v end })
SilentAimSection:Dropdown({ Title = "Hit Part", Values = {"Head", "UpperTorso", "HumanoidRootPart"}, Value = "Head", Callback = function(v) Settings.SilentAim.HitPart = v end })
SilentAimSection:Toggle({ Title = "Show FOV Circle", Value = false, Callback = function(v) Settings.FOVCircle = v end })

local SpinbotSection = CombatTab:Section({ Title = "Spinbot" })
SpinbotSection:Toggle({ Title = "Enabled", Callback = function(v) Settings.Spinbot.Enabled = v; updateSpinbot() end })
SpinbotSection:Slider({ Title = "Speed", Step = 1, Value = { Min = 1, Max = 50, Default = 10 }, Callback = function(v) Settings.Spinbot.Speed = v end })

local MovementSection = CombatTab:Section({ Title = "Movement" })
MovementSection:Toggle({ Title = "Bunny Hop", Callback = function(v) Settings.Bhop = v; updateBhop() end })
MovementSection:Slider({ Title = "Walk Speed", Step = 1, Value = { Min = 16, Max = 50, Default = 16 }, Callback = function(v)
...
local CameraSection = VisualsTab:Section({ Title = "Camera" })
CameraSection:Toggle({ Title = "Third Person", Callback = function(v) Settings.ThirdPerson = v; updateThirdPerson() end })
CameraSection:Slider({ Title = "Distance", Step = 1, Value = { Min = 5, Max = 30, Default = 10 }, Callback = function(v)
...
ESPSection:Toggle({ Title = "Skeleton (R6/R15)", Value = true, Callback = function(v) Settings.ESP.Skeleton = v end })
...
WindUI:Notify({ Title = "Tulip", Content = "Loaded! Press Insert to open menu." })
print("Tulip.lua – All features ready.")